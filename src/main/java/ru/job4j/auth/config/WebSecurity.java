...
import ru.job4j.auth.service.PersonDetailsService;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurity(PersonDetailsService personDetailsService, BCryptPasswordEncoder bCryptPasswordEncoder) {
